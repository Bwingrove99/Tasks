...
#The graph shows a strong positive correlation between diversification and number of tips 
...
cor(vartraits, rates)
#I see a positive correlation between variance of traits and rates.
#Question 10
trait1 <- traits[1]
trait1
trait2 <- traits[2]
...
#Correlation is almost 0 which tells me that this is not significant
